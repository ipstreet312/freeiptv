...
s = requests.Session()
response = s.get(f'https://hdfauth.ftven.fr/esi/TA?url=https://live-ssai-v2.ftven.fr/dai/v1/master/c6f323e65336fbba9ea766d582216fd61ed74452/SSAIFrance5OTTEMTConfiguration/out/v1/41715168bc484ad3a44f91d2c4e929b8/index.m3u8')
...
new_string2 = new_string.replace("out/v1/41715168bc484ad3a44f91d2c4e929b8/index.m3u8", f'{sessid}/4.m3u8')
print(new_string2)
