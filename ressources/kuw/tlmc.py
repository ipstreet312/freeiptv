...
playlist = streams["best"].multivariant.uri
...
print('#EXT-X-MEDIA:GROUP-ID="audio_256000",TYPE=AUDIO,LANGUAGE="en",NAME="English",AUTOSELECT=YES,DEFAULT=YES,CHANNELS="2",URI="print(hls_a1)"')
print('#EXT-X-MEDIA:GROUP-ID="audio_128000",TYPE=AUDIO,LANGUAGE="en",NAME="English",AUTOSELECT=YES,DEFAULT=YES,CHANNELS="2",URI="{}"'.format(hls_a2), end='')
