...
s = requests.Session()
response = s.get(f'https://hdfauth.ftven.fr/esi/TA?url=https://live-ssai.ftven.fr/dai/v1/master/14bff07f70f2518f32f1c6cc13a91ef489dc83f1/SSARFrance5OTTEMTConfiguration/out/v1/46920d328ac14465af4ab26c2b853fdd/index.m3u8')
...
new_string2 = new_string.replace("out/v1/46920d328ac14465af4ab26c2b853fdd/index.m3u8", f'{sessid}/4.m3u8')
print(new_string2)
